...
set env CURRENT_NETLIST ./results/synthesis/digital_cs.v
...
set env SAVE_DEF ./results/floorplan/digital_cs.def
set env SAVE_NETLIST ./out.v
set env SAVE_ODB ./results/floorplan/digital_cs.odb
