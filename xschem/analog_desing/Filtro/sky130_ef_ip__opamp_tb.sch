...
N 780 -1110 780 -1070 {
lab=GND}
C {vsource.sym} 470 -1270 0 0 {name=V1 value=3.3}
...
C {vsource.sym} 610 -1230 0 0 {name=V2 value="PWL(0 0 1u 0 1m 3.3)"}
...
C {lab_pin.sym} 610 -1280 0 0 {name=p5 sig_type=std_logic lab=in}
C {sky130_ef_ip__opamp.sym} 1030 -1300 0 0 {name=x1}
C {vsource.sym} 780 -1140 0 0 {name=V3 value=3.3}
